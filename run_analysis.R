...
setwd("~/RData/GettingCleaningData-Coursera")
...
# select only columns corresponding to mean() and std() measurements
...
# data2 is a copy of data containing the only columns not of interest
